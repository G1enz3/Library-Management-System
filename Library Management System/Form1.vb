...
Public Class Form1
    ...
    Dim Server As String = "Glenzy"
    Dim Database As String = "LibraryDB"

    Private bitmap As Bitmap
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'LibraryDBDataSet2.Books' table. You can move, or remove it, as needed.
        Me.BooksTableAdapter.Fill(Me.LibraryDBDataSet2.Books)
        updatetable()
    End Sub
